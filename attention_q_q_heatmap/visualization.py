...
if 1:
    ...
    attn_without_cls = q @ q.transpose(-2, -1)
    ...
    """将图像保存到文件"""
    print(os.path.join("/hy-tmp/explore_attention_vit/attention_q_q_heatmap/", "heatmap_qq_"+file.split('.')[0]+'.png'))
    plt.savefig(os.path.join("/hy-tmp/explore_attention_vit/attention_q_q_heatmap/", "heatmap_qq_"+file.split('.')[0]+'.png'), dpi=300)
    plt.close() 
